...
@ActiveProfiles("test")
public class AvamEventReceiverGatewayTest {

	@Autowired
	private AvamEventReceiverGateway avamEventReceiverGateway;
	...
	public void sendEmailIfCancellationDtoNotFound() {
		...
		// when
		avamEventReceiverGateway.handleCancelAction(cancellationDto);
	...
	public void dontSendCancellationEmailDirectlyIfFound() {
		...
		// when
		avamEventReceiverGateway.handleCancelAction(avamCancellationDto);
