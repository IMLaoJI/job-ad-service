...
The phone numbers are sent as string in the format "\+41123456789" (Regex "[+][1-9][0-9]{7,18}").
The phone numbers are also validated using the com.google.i18n.phonenumbers.PhoneNumberUtil utility.
...
The required occupation code is found in **column D of sheet "AVAM-Berufe komplett NEU"
**link:AVAM-Berufsliste_API_April_2019.xlsx[Download occupations Excel sheet]