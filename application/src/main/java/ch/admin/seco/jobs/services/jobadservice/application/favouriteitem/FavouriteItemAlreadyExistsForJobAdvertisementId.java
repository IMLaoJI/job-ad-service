...
public class FavouriteItemAlreadyExistsForJobAdvertisementId extends RuntimeException {

    FavouriteItemAlreadyExistsForJobAdvertisementId(FavouriteItemId favouriteItemId, JobAdvertisementId jobAdvertisementId, String ownerid) {
