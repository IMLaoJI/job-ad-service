...
@AlvUnauthorizedFeignClient(name = "referenceservice", contextId = "jobcenter-api", url = "${feign.referenceservice.url:}", fallback = JobCenterApiClientFallback.class, path = "/api/job-centers")
