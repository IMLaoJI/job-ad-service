...
@AlvUnauthorizedFeignClient(name = "referenceservice", contextId = "location-api", url = "${feign.referenceservice.url:}",
        fallback = LocationApiClientFallback.class, path = "/api/localities" )
