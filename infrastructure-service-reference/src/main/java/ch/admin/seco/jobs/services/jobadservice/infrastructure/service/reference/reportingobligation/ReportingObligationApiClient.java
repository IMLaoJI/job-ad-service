...
@AlvUnauthorizedFeignClient(name = "referenceservice", contextId = "reportingobligation-api", url = "${feign.referenceservice.url:}", fallback = ReportingObligationApiClientFallback.class, path = "/api/reporting-obligations")
